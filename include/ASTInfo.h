...
struct ASTLoop{
        ...
        std::vector<unsigned int> InternLoopsBegin;
        std::vector<unsigned int> InternLoopsEnd;
	...
	int type;
        ...
        std::vector<std::string> stenoutputs;
        std::vector<std::string> steninputs;
        std::vector<std::string> steninputTypes;
        std::vector<std::string> stenoutputTypes;
};
